...
var circleArr = [[],[],[],[],[],[],[],[],[]];
var currentCat;
var MOVE_NONE=-1, MOVE_LEFT=0, MOVE_UP_LEFT, MOVE_UP_RIGHT=2, MOVE_RIGHT=3, MOVE_DOWN_RIGHT=4, MOVE_DOWN_LEFT=5;
...
function getMoveDir(cat){
    ...
    for(var x=cat.indexX; x>=0; x--){
        if(circleArr[x][cat.indexY].getCircleType()==Circle.TYPE_SELECTED){
            can=false;
            distanceMap[MOVE_LEFT]=cat.indexX-x; //记录还有多少可移动距离
            break;
        }
    }
    if(can){
